...
const DepoimentosSection: React.FC = () => {
    ...
    return (
        <section id="depoimentos" className="py-24 bg-gray-950 text-[#F8F9FA]">
            <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
                <h2 className="text-sm font-semibold tracking-widest uppercase text-[#C8A97E] mb-3">
                ...
                >
                    {testimonials.map((t, index) => (
                        <motion.div
                            ...
                            className="relative p-8 pt-12 bg-gray-900 rounded-2xl shadow-xl border-t-4 border-[#c8a97e]/50 hover:shadow-[#c8a97e]/10 transition-shadow duration-300 transform hover:scale-[1.01] text-left h-full flex flex-col justify-between"
                        >
                            <Quote
                                className="absolute top-4 left-6 text-[#c8a97e]/40 w-10 h-10"
                                aria-hidden="true"
                            />
                            ...
                            <div className="mt-auto">
                                <p className="font-semibold text-lg text-[#C8A97E] uppercase tracking-wider">
                                    {t.client}
                                </p>
                ...
                <div className="mt-16">
                    <a
                        href="#contato"
                        className="inline-flex items-center text-lg font-medium text-[#C8A97E] hover:text-yellow-500 transition-colors"
                    >
